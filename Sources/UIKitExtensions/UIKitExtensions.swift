...
extension UIEdgeInsets {
    /**
     Creates a UIEdgeInsets inset an equal amount
...
extension UIView {
    ...
    /**
     ...
     - Returns: The receiver. This is done so that you can chain multiple expressions together, like so:
            ...
            let view = UIView().withContentCompressionResistance(.required, for: .horizontal)
     */
    @discardableResult
    public func withContentCompressionResistance(_ priority: UILayoutPriority, for axis: NSLayoutConstraint.Axis) -> Self {
    ...
    /**
     ...
     - Returns: The receiver. This is done so that you can chain multiple expressions together, like so:
            ...
            let view = UIView().withContentHugging(.required, for: .horizontal)
     */
    @discardableResult
    public func withContentHugging(_ priority: UILayoutPriority, for axis: NSLayoutConstraint.Axis) -> Self {
     ...
     */
    @discardableResult
    public func fillUpSuperview(insets: UIEdgeInsets = .zero, priorities: LayoutPriorities = .required, except excludedEdge: Edge = [], useSafeAreaInsets: Bool = false) -> Self {
        guard let superview = self.superview else {
     ...
     */
    @discardableResult
    public func pin(edge: Edge, to otherEdge: Edge, of siblingView: UIView, offset: CGFloat = 0, priority: UILayoutPriority = .required) -> Self {
     ...
     */
    @discardableResult
    public func pinEdgeToSuperview(edge: Edge, offset: CGFloat = 0, priority: UILayoutPriority = .required, useSafeAreaInsets: Bool = false) -> Self {
        guard let superview = self.superview else {
     ...
     */
    @discardableResult
    public func match(dimension: Dimension, to otherDimension: Dimension, of otherView: UIView, offset: CGFloat = 0, multiplier: CGFloat = 1, priority: UILayoutPriority = .required) -> Self {
     ...
     */
    @discardableResult
    public func set(dimension: Dimension, to offset: CGFloat, priority: UILayoutPriority = .required) -> Self {
        self.translatesAutoresizingMaskIntoConstraints = false
